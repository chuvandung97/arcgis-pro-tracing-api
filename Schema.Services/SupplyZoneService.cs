...
{
    public class SupplyZoneService : ISupplyZoneService
    {
        ILoggingService _loggingService;
        ISupplyZoneDataService _supplyZoneDataService;

        Dictionary<string, object> errorLogInfo;
        public SupplyZoneService(ILoggingService LoggingService, ISupplyZoneDataService SupplyZoneDataService)
        {
            _loggingService = LoggingService;
            _supplyZoneDataService = SupplyZoneDataService;
        }
