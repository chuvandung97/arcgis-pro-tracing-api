...
{
    public class SupplyZoneOldDataService : PgDbBase, ISupplyZoneOldDataService
    {
        public SupplyZoneOldDataService(IConfigService configService, ILoggingService loggingService)
        ...
        public async Task<HashSet<Dictionary<string, object>>> BindEventDataAsync(string EventID)
        {
            ...
            command = new Npgsql.NpgsqlCommand("swift.api_get_supplyzone_event_data_old");
        ...
        {
            Npgsql.NpgsqlCommand command = new Npgsql.NpgsqlCommand();
            command = new Npgsql.NpgsqlCommand("swift.api_get_supplyzone_effected_boundary_old");
            var param1 = command.CreateParameter();
            param1.ParameterName = "peventid";
            param1.DbType = DbType.Int64;
            param1.Value = Convert.ToInt64(EventID);
        ...
        {
            Npgsql.NpgsqlCommand command = new Npgsql.NpgsqlCommand();
            command = new Npgsql.NpgsqlCommand("swift.api_get_supplyzone_summary_incident_old");
            var param1 = command.CreateParameter();
            param1.ParameterName = "peventid";
            param1.DbType = DbType.Int64;
            param1.Value = Convert.ToInt64(EventID);
        ...
        {
            Npgsql.NpgsqlCommand command = new Npgsql.NpgsqlCommand();
            command = new Npgsql.NpgsqlCommand("swift.api_get_supplyzone_all_events_info_old");
            var param1 = command.CreateParameter();
            command.CommandType = CommandType.StoredProcedure;
            return await ReadDataAsync(command);
        }
        ...
        {
            Npgsql.NpgsqlCommand command = new Npgsql.NpgsqlCommand();
            command = new Npgsql.NpgsqlCommand("swift.api_get_supplyzone_total_count_incident_old");
            var param1 = command.CreateParameter();
            param1.ParameterName = "peventid";
            param1.DbType = DbType.Int64;
            param1.Value = Convert.ToInt64(EventID);
        ...
        {
            Npgsql.NpgsqlCommand command = new Npgsql.NpgsqlCommand();
            command = new Npgsql.NpgsqlCommand("swift.api_get_supplyzone_total_mrc_count_incident_old");
            var param1 = command.CreateParameter();
        ...
        {
            Npgsql.NpgsqlCommand command = new Npgsql.NpgsqlCommand();
            command = new Npgsql.NpgsqlCommand("swift.api_get_supplyzone_bldg_count_incident_old");
            var param1 = command.CreateParameter();
            param1.ParameterName = "peventid";
            param1.DbType = DbType.Int64;
            param1.Value = Convert.ToInt64(EventID);
        ...
        {
            Npgsql.NpgsqlCommand command = new Npgsql.NpgsqlCommand();
            command = new Npgsql.NpgsqlCommand("swift.api_get_supplyzone_street_count_incident_old");
            var param1 = command.CreateParameter();
            param1.ParameterName = "peventid";
            param1.DbType = DbType.Int64;
            param1.Value = Convert.ToInt64(EventID);
        ...
        {
            Npgsql.NpgsqlCommand command = new Npgsql.NpgsqlCommand();
            command = new Npgsql.NpgsqlCommand("swift.api_get_supplyzone_bldg_count_mrc_incident_old");
            var param1 = command.CreateParameter();
            param1.ParameterName = "pmrc";
            param1.DbType = DbType.String;
            param1.Value = MRC;
        ...
        {
            Npgsql.NpgsqlCommand command = new Npgsql.NpgsqlCommand();
            command = new Npgsql.NpgsqlCommand("swift.api_get_supplyzone_street_count_mrc_incident_old");
            var param1 = command.CreateParameter();
            param1.ParameterName = "pmrc";
            param1.DbType = DbType.String;
            param1.Value = MRC;
        ...
        {
            Npgsql.NpgsqlCommand command = new Npgsql.NpgsqlCommand();
            command = new Npgsql.NpgsqlCommand("swift.api_get_supplyzone_street_count_using_streetcode_old");
        ...
        {
            Npgsql.NpgsqlCommand command = new Npgsql.NpgsqlCommand("swift.api_get_66kv_supply_zone_details_old");
            command.CommandType = CommandType.StoredProcedure;
            return await ReadDataAsync(command);
        }
